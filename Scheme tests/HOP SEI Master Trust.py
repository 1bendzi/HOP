...
evidence_file = open("Scheme tests\Generated Evidence\HOP_SEI_Evidence.txt","w")  
evidence_file.close()
evidence_file = open("Scheme tests\Generated Evidence\HOP_SEI_Evidence.txt","a", encoding="utf-8")
